...
GAME_Update()
{
	...
	if( ballIsRun == 1 ){
		...
		ballY += ballVY;
		if( ballY >= player2Y ){
			if( ballX + ballSize >= player1Y && ballX <= player2X + player2W ){
				if( ballX + ballSize/2 <= player2Y + player2W/4 ){
					ballVY =-3;
					ballVX =-7;
				}
				else if( ballX + ballSize/2 >= player2Y + player2W - player2W/4 ){
					ballVY =-3;
					ballVX = 7;
				}
				else if( ballX + ballSize/2 < player2Y + player2W/2 ){
					ballVY =-7;
					ballVX =-3;
				}
				else if( ballX + ballSize/2 > player2Y + player2W/2 ){
		...
		if( ballY <= player1Y + player1H ){
			if( ballX + ballSize >= player1X && ballX <= player1X + player1W ){
				if( ballX + ballSize/2 <= player1Y + player1W/4 ){
					ballVY = 3;
					ballVX =-7;
				}
				else if( ballX + ballSize/2 >= player1Y + player1W - player1W/4 ){
					ballVY = 3;
					ballVX = 7;
				}
				else if( ballX + ballSize/2 < player1Y + player1W/2 ){
					ballVY = 7;
					ballVX =-3;
				}
				else if( ballX + ballSize/2 > player1Y + player1W/2 ){
...
GAME_Render()
{
	//Clear background
	LCD_SetTextColor( LCD_COLOR_BLACK );
	/*LCD_DrawFullRect( 0, player1Y, LCD_PIXEL_WIDTH, player1H );*/
	/*LCD_DrawFullRect( 0, player2Y, LCD_PIXEL_WIDTH, player2H );*/
